...
const semanticTokens: SemanticTokens = {
  ...
  feedback: {
    success: {
      bg: baseTokens.colors.success[50],
      border: baseTokens.colors.success[200],
      text: baseTokens.colors.success[700],
      icon: baseTokens.colors.success[500]
    },
    warning: {
      bg: baseTokens.colors.warning[50],
      border: baseTokens.colors.warning[200],
      text: baseTokens.colors.warning[800],
      icon: baseTokens.colors.warning[500]
    },
    error: {
      bg: baseTokens.colors.error[50],
      border: baseTokens.colors.error[200],
      text: baseTokens.colors.error[700],
      icon: baseTokens.colors.error[500]
    },
    info: {
      bg: baseTokens.colors.info[50],
      border: baseTokens.colors.info[200],
      text: baseTokens.colors.info[700],
